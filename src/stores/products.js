...
export const useProductStore = defineStore('product', {
  state: () => ({
    products: [
      // Outfits with sizes
      { id: 1, name: 'Hottie Nurse Costume', price: '500.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/80859_a44920_white_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L', 'XL'] },
      { id: 2, name: 'Latex Plunge Skater Dress', price: '550.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/70187_a37901_black_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 3, name: 'Siren Fishnet and Wet Look Open-Cup Body', price: '450.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/83787_a46636_black_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L', 'XL'] },
      { id: 4, name: 'Kitty Bondage Hood', price: '150.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/72850_a39764_black_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['One Size'] },
      { id: 5, name: 'Kitty Open Mouth Bondage Hood', price: '150.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/72851_a39765_black_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['One Size'] },
      { id: 6, name: 'Leather Body Harness with Cock Ring and Wrist Cuffs', price: '155.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/61300_a34159_black_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      ...
      { id: 8, name: 'Puppy Play Hood', price: '260.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/86374_a48527_black_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['One Size'] },
      { id: 9, name: 'Power Sexy Cop Costume', price: '255.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/60186_a33721_blue_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 10, name: 'Doctor Love Costume', price: '150.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/85901_a48166_white_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 11, name: 'Seaman Costume', price: '250.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/75584_a41523_white_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 12, name: 'Garter Shorts', price: '125.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/33043_a22960_black_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 13, name: 'Leather Harness with Butt Plug and Cock Cage', price: '160.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/68216_a36900_black_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 14, name: 'Vinyl Naughty Nurse Set (4 Piece)', price: '460.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/83612_a46521_black_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 15, name: 'Golden Angel Costume', price: '400.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/86420_a48571_gold_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 16, name: 'Warrior Goddess Superhero Costume', price: '350.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/77032_a42814_red_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 17, name: 'Cheetah Woman', price: '450.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/85215_a47621_gold_regular_000?$primary$&h=632&w=474&fmt=jpeg&unsharp=0,1,1,7&qlt=55', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 38, name: 'Charm Red Corset', price: '400.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/86033_a48249_red_x-size_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'advanced', sizes: ['S', 'M', 'L', 'XL'] },
      { id: 39, name: 'White Merry Set', price: '250.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/83746_a36251_white_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'advanced', sizes: ['S', 'M', 'L'] },
      { id: 40, name: 'Basque Set With Handcuff', price: '350.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/86578_a48685_black_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'advanced', sizes: ['S', 'M', 'L'] },
      { id: 41, name: 'Luxury Crotchless Body', price: '350.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/83772_a46630_black_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'advanced', sizes: ['S', 'M', 'L'] },
