...
export const useProductStore = defineStore('product', {
  state: () => ({
    products: [
      ...
      { id: 17, name: 'Cheetah Woman', price: '35.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/85215_a47621_gold_regular_000?$primary$&h=632&w=474&fmt=jpeg&unsharp=0,1,1,7&qlt=55', type: 'outfit', level: 'all', sizes: ['S', 'M', 'L'] },
      { id: 38, name: 'Charm Red Corset', price: '27.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/86033_a48249_red_x-size_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'advanced', sizes: ['S', 'M', 'L', 'XL'] },
      { id: 39, name: 'White Merry Set', price: '12.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/83746_a36251_white_regular_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'outfit', level: 'advanced', sizes: ['S', 'M', 'L'] },
      ...
      // Wellness (no sizes)
      { id: 36, name: 'Water Based Lube', price: '10.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/37109_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'wellness', level: 'advanced' },
      { id: 37, name: 'Liquid Silk Lube', price: '12.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/7163_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'wellness', level: 'advanced' },
      { id: 42, name: 'Anal Lube', price: '10.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/45600_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'wellness', level: 'advanced' },
      { id: 43, name: 'Anti Bacterial Cleanser', price: '10.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/37110_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'wellness', level: 'advanced' },
      { id: 44, name: 'Toy Battery', price: '3.00', image: 'https://media.lovehoneyassets.com/i/lovehoney/82362_000?$primary$&h=371&w=278&fmt=auto&qlt=80', type: 'wellness', level: 'advanced' }
    ]
  }),
